...
public class Revue {
	...
	private int tarif_numero;
	private String visuel;
	private int id_periodicite;
	
public Revue(String titre,String description,int tarif_numero,String visuel,int id_periodicite) {
...
public void setTarif_numero(int tarif_numero) {
	if ((Integer)tarif_numero==null) {
		throw new IllegalArgumentException("Traif numero vide !");
		}
	this.tarif_numero = tarif_numero;
}
